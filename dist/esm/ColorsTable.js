...
const ColorPallete = ({ title, swatches }) => {
    return (jsxs("div", { children: [jsx("h3", { className: "docs-mb-4 docs-text-lg docs-font-bold", children: title }), jsx("div", { className: "docs-grid docs-grid-flow-col docs-gap-2", children: swatches.map(({ name, color }) => (jsx(ColorSwatch, { name: name, color: color }, name))) })] }));
};
