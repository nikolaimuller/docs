...
const ColorPallete = ({ title, swatches }) => {
    return (jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx("h3", { className: "docs-mb-4 docs-text-lg docs-font-bold", children: title }), jsxRuntime.jsx("div", { className: "docs-grid docs-grid-flow-col docs-gap-2", children: swatches.map(({ name, color }) => (jsxRuntime.jsx(ColorSwatch, { name: name, color: color }, name))) })] }));
};
